...
// --- ADDED: Icon components for the show/hide button ---
const EyeIcon = (props) => (
...
            />
          </div>
          {/* --- MODIFIED: Password input with Show/Hide toggle --- */}
          <div>
            <label htmlFor="password" className="mb-2 block text-sm font-medium text-slate-300">Password</label>
            <div className="relative">
              <input
                ...
                className="w-full rounded-md border-slate-700 bg-slate-900 p-3 pr-10" // Added pr-10 for padding
                required
              />
              <button
                type="button"
